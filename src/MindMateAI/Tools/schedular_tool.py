...
if __name__ == "__main__":
    ...
    I've been having severe panic attacks every day this week. I can't sleep, 
    I'm not eating much, and I feel completely overwhelmed. I've been avoiding 
    going to work because I'm afraid I'll have another panic attack. I need 
    help with cognitive restructuring and some relaxation techniques.
    """
    
    # Standard urgency example
    standard_example = """
    I've been feeling down lately and having some negative thought patterns. 
    I'd like to work on mindfulness and maybe some behavioral activation. 
    I think activity scheduling might help me get back into a routine.
    """
    
    print("=== TESTING HIGH URGENCY SCENARIO ===")
    result1 = resource_scheduler.invoke(high_urgency_example)
    print(f"Urgency Level: {result1['urgency_level']}")
    print(f"First Session: {result1['recommended_schedule']['first_session']}")
    print(f"Session Frequency: {result1['recommended_schedule']['session_frequency']}")
    print(f"Number of Resources: {len(result1['resources'])}")
    print(f"Homework Assignments: {len(result1['homework_assignments'])}")
    
    print("\n=== TESTING STANDARD SCENARIO ===")
    result2 = resource_scheduler.invoke(standard_example)
    print(f"Urgency Level: {result2['urgency_level']}")
    print(f"First Session: {result2['recommended_schedule']['first_session']}")
    print(f"Session Frequency: {result2['recommended_schedule']['session_frequency']}")
    print(f"Primary Focus Areas: {result2['session_recommendations']['primary_focus_areas']}")